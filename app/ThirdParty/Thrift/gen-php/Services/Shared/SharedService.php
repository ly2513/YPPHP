...
class SharedServiceClient implements \Services\Shared\SharedServiceIf {
  ...
  public function recv_getStruct()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Services\Shared\SharedService_getStruct_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
